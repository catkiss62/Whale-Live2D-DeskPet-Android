...
No purchased Live2D model, textures, motions, expressions, VTube Studio configuration, or other Q-version whale model assets are included in this repository or APK.
