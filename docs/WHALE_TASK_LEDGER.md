...
## v0.2.1-full-controls（已构建、待实机确认）
...
- 远端功能提交：`c962e971cdbb25a47da0a25c22b78db39b7ce8c7`（Git 树 `420fa8bcaa154af9bab357862afd6f2c1ba39908`）。
- GitHub Actions：run `35520054441`，`assembleDebug` 与 APK artifact 上传均成功。
- Artifact：`Whale-Live2D-DeskPet-Test-APK`，ID `10607524424`。
- Artifact ZIP SHA-256：`f2e7a1b150f1c38ece1429405d5c7f74de9a2b0aab0dd95baa80fa6e58cee42b`（与 GitHub artifact digest 一致）。
- `app-debug.apk` SHA-256：`1d8eaaf3a028671d16efc1b266a1b0d8d83b17ec03920afa1a3c70250a432131`。
- ZIP 完整性、v0.2.1/GB18030 代码特征与购买素材排除检查均通过。
...
1. 用户覆盖安装后先观察旧目录的编号按钮，再重新导入 ZIP，确认中文目录与 `13/13`。
2. 根据逐项按钮测试结果筛选原生动作/表情；本轮暂不验收悬浮桌宠，也不接入LLM。
